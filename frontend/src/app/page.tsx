...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <section id="productos-destacados" className="border-b border-line bg-white px-4 py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-10 text-center">
            <Button href="/productos" variant="primary">Ver todo el catálogo</Button>
          </div>
        </div>
      </section>

      {/* ¿Por qué elegirnos? — foto + título fuerte + beneficios en mini-cards */}
      <section id="por-que-elegirnos" className="border-b border-line bg-surface px-4 py-24">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-12 lg:flex-row lg:items-stretch lg:gap-16">
          ...
          <div className="flex flex-1 flex-col justify-center lg:max-w-xl">
            ...
            <div className="mt-8 space-y-4">
              <div className="flex gap-4 rounded-xl border border-line bg-white p-4 transition hover:shadow-md">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center text-brand" aria-hidden>
                ...
                <div>
                  <h3 className="font-semibold text-ink">Calidad durable</h3>
                  <p className="mt-0.5 text-base text-ink-soft">Telas y costuras pensadas para el uso intensivo.</p>
                </div>
              </div>
              <div className="flex gap-4 rounded-xl border border-line bg-white p-4 transition hover:shadow-md">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center text-brand" aria-hidden>
                ...
                <div>
                  <h3 className="font-semibold text-ink">Atención personalizada</h3>
                  <p className="mt-0.5 text-base text-ink-soft">Asesoramos en talles, modelos y pedidos por cantidad.</p>
                </div>
              </div>
              <div className="flex gap-4 rounded-xl border border-line bg-white p-4 transition hover:shadow-md">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center text-brand" aria-hidden>
                ...
                <div>
                  <h3 className="font-semibold text-ink">Entrega a todo el país</h3>
                  <p className="mt-0.5 text-base text-ink-soft">Coordinamos envíos para que recibas tu pedido a tiempo.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="como-trabajamos" className="border-b border-line bg-surface px-4 py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-14 flex flex-col divide-y divide-line sm:flex-row sm:divide-x sm:divide-y-0">
            {/* Card 1 — Consultá */}
            <article className="flex flex-1 flex-col items-center rounded-lg px-6 py-10 text-center transition-colors hover:bg-white">
              <div className="mb-5 flex h-16 w-16 items-center justify-center text-brand" aria-hidden>
              ...
              <h3 className="text-sm font-bold uppercase tracking-wide text-ink">Consultá</h3>
            ...
            <article className="flex flex-1 flex-col items-center rounded-lg px-6 py-10 text-center transition-colors hover:bg-white">
              ...
              <h3 className="text-sm font-bold uppercase tracking-wide text-ink">Elegí del catálogo</h3>
              <p className="mt-3 text-base leading-relaxed text-ink-soft">
            ...
            <article className="flex flex-1 flex-col items-center rounded-lg px-6 py-10 text-center transition-colors hover:bg-white">
              ...
              <h3 className="text-sm font-bold uppercase tracking-wide text-ink">Confirmamos tu pedido</h3>
              <p className="mt-3 text-base leading-relaxed text-ink-soft">
            ...
            <article className="flex flex-1 flex-col items-center rounded-lg px-6 py-10 text-center transition-colors hover:bg-white">
              ...
              <h3 className="text-sm font-bold uppercase tracking-wide text-ink">Entrega</h3>
              <p className="mt-3 text-base leading-relaxed text-ink-soft">
      ...
      {/* CTA cotización */}
      <section id="cotizacion-cta" className="border-b border-line bg-white px-4 py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8">
            <Button href="/cotizacion" variant="primary">Pedir cotización</Button>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto flex max-w-4xl flex-col items-center gap-8 text-center">
          <div className="flex flex-wrap items-center justify-center gap-6">
            ...
            <span className="flex items-center gap-3" aria-hidden>
              <a href="#" className="cursor-pointer rounded-full p-2 text-ink-soft transition hover:bg-white hover:text-ink focus:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2" aria-label="Instagram">
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              ...
              <a href="#" className="cursor-pointer rounded-full p-2 text-ink-soft transition hover:bg-white hover:text-ink focus:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2" aria-label="LinkedIn">
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
